...
const BrowserAppToolbar: React.FC<BrowserAppToolbarProps> = ({
  ...
  return (
    <Paper elevation={2} className='p-2 w-full rounded-0' sx={
      {
      ...
      <IconButton aria-label='mobile view' onClick={() => onScreenSizeChange('mobile')}>
        <MobileScreenShareIcon />
      </IconButton>
      <IconButton aria-label='tablet view' onClick={() => onScreenSizeChange('tablet')}>
        <TabletIcon />
      </IconButton>
      <IconButton aria-label='desktop view' onClick={() => onScreenSizeChange('desktop')}>
        <LaptopIcon />
      </IconButton>
      </Box>
    </Paper>
