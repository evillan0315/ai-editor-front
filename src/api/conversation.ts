...
export async function getConversations(
  ...
  if (paginationDto.page) queryParams.append('page', paginationDto.page.toString());
  if (paginationDto.limit) queryParams.append('limit', paginationDto.limit.toString());
  if (paginationDto.search) queryParams.append('search', paginationDto.search);
  if (paginationDto.requestType) queryParams.append('requestType', paginationDto.requestType);
  ...
  const data: PaginatedResponseDto<ConversationSummaryDto> = await response.json();
